...
<html class="wide wow-animation" lang="en"> 
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/footer.css"  /> <!--footer old -->
			...
			<div class="rd-navbar-main-outer">
			  <div class="rd-navbar-main">
				...
				<div class="rd-navbar-panel"> 
				  ...
				  <!-- RD Navbar Brand-->
				  <div class="rd-navbar-brand"><a href="{{ URL::to('/')}}"><img class="brand-logo-light" src="images/logo.jpg" alt="" width="140" height="57" srcset="images/logo-default-280x113.png 2x"/></a></div>
				</div>
